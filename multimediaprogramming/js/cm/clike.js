...
(function() {
  ...
  CodeMirror.defineMIME("text/x-processing", {
    name: "clike",
    keywords: words('abstract ArrayList assert boolean break byte case catch char class continue curve curveTightness' +
			...
			'throws transient try void volatile while true setup draw size strokeWeight stroke background pushMatrix popMatrix translate ' +
    ...
    atoms: words('mouseX mouseY height width frameCount TWO_PI PI HALF_PI QUATER_PI ' +
